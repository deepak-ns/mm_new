...
simulator.py
------------
Monte Carlo simulator that runs a cohort of users through simulated days under
a given policy, collecting per-step reward, state, and action data.
"""
...
def run_both_policies(
    ...
    """
    Runs baseline then MDP policy on the same cohort.
    """
